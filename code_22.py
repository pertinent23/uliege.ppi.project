...
def show_score():
    ...
    score_title_surface = score_font.render("Score:", True, RED)
    score_dist_surface= score_font.render( "Distance parcourue:" +" {0:.1f}".format(score), True, RED)
    score_coins_surface = score_font.render(str(score_piece)+" " +"pièce(s) gagnée(s)",True, RED)
    score_title = score_title_surface.get_rect()
    score_dist = score_dist_surface.get_rect()
    score_coins= score_coins_surface.get_rect()

    # score_rect_1 = pygame.Rect.unionall(score_title,score_dist)
    # score_rect =  pygame.Rect.unionall(score_coins,score_rect_1)
    
    score_title.midtop = (FENETRE_LARGEUR/2, 270)
    score_dist.midtop = (FENETRE_LARGEUR/2, 320)
    score_coins.midtop = (FENETRE_LARGEUR/2, 370)

    fenetre.blit(score_coins_surface, score_coins)
    fenetre.blit(score_title_surface, score_title)
    fenetre.blit(score_dist_surface, score_dist)
    # pygame.display.flip()

def game_over():
    my_font = pygame.font.SysFont('times new roman', 90)
    game_over_surface = my_font.render('GAME OVER', True, JAUNE)
    game_over_rect = game_over_surface.get_rect()
    game_over_rect.midtop = (FENETRE_LARGEUR / 2, FENETRE_HAUTEUR / 4)
    fenetre.fill(BLANC)
    # fenetre.set_alpha(50)  
...
IMAGE_BALLE_30_DEG = creerBalleImage("images/ball/ball.30.png")
IMAGE_BALLE_45_DEG = creerBalleImage("images/ball/ball.45.png")
IMAGE_BALLE_60_DEG = creerBalleImage("images/ball/ball.60.png")
IMAGE_BALLE_90_DEG = creerBalleImage("images/ball/ball.90.png")
IMAGE_BALLE_120_DEG = creerBalleImage("images/ball/ball.120.png")
IMAGE_BALLE_135_DEG = creerBalleImage("images/ball/ball.135.png")
IMAGE_BALLE_150_DEG = creerBalleImage("images/ball/ball.150.png")
IMAGE_BALLE_180_DEG = creerBalleImage("images/ball/ball.180.png")
IMAGE_BALLE_210_DEG = creerBalleImage("images/ball/ball.210.png")
IMAGE_BALLE_225_DEG = creerBalleImage("images/ball/ball.225.png")
IMAGE_BALLE_240_DEG = creerBalleImage("images/ball/ball.240.png")
IMAGE_BALLE_270_DEG = creerBalleImage("images/ball/ball.270.png")
IMAGE_BALLE_300_DEG = creerBalleImage("images/ball/ball.300.png")
IMAGE_BALLE_315_DEG = creerBalleImage("images/ball/ball.315.png")
